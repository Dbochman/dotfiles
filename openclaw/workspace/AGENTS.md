...
Use reactions to acknowledge messages without cluttering the chat. One reaction per message max.

For iMessage-specific reaction types and strings, see `SOUL.md` — the rules there override anything here.
