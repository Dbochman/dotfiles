#!/bin/bash
# Start dog-walk policy automation with cache-only secrets.
...
LOG="$HOME/.openclaw/logs/dog-walk-automation.log"
...
exec "$HOME/.openclaw/ring/venv/bin/python3" \
  "$HOME/.openclaw/skills/dog-walk/dog-walk-automation.py"
