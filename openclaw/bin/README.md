...
| `home-event-correlator.py` | Persistent correlator that claims durable consumer rows, applies fail-closed canonical presence context, groups site incidents, and records rate-limited shadow decisions or owner-only reservations without external delivery or camera work. |
