...
| [dog-walk-listener-hardening](archive/dog-walk-listener-hardening.md) | Thread-safety and async hot-path hardening for `dog-walk-listener.py` | Complete |
...
| [openclaw-2026-6-native-imessage-migration](archive/openclaw-2026-6-native-imessage-migration.md) | Upgrade to OpenClaw 2026.6 and migrate BlueBubbles to native `imsg` iMessage | Complete; BlueBubbles retired |
...
| [system-hardening-2026-04](archive/system-hardening-2026-04.md) | April reliability, deployment, and automation hardening sprint | Complete; historical transport details superseded |
